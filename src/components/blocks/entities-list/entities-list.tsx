 ...
 */
export default function EntitiesList({ filterQueryString }: EntitiesListProps) {
  ...
  /**
   * Make sure to rebuild the tree when the filter query changes.
   */
  // biome-ignore lint/correctness/useExhaustiveDependencies: <filterQueryString is necessary here!>
  useMemo(tree.scheduleRebuildTree, [filterQueryString]);
